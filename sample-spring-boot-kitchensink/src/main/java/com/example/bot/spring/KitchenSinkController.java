...
public class KitchenSinkController {
    ...
    public void handleMemberJoined(MemberJoinedEvent event) {
        String replyToken = event.getReplyToken();
        this.replyText(replyToken, "歡迎狼窩" + event.getJoined().getMembers()
                                                                      .stream().map(Source::getDisplayName)
                                                               ...
                                                               "\r\n" + 
                                                               "4. 請問我揪桌遊團可以幹嘛？\r\n" + 
                                                               "答：可以認識新朋友，累積特定桌遊的同好，害羞的人也可先從參加別人桌遊團開始。每主揪三次可於每半年兌換一張抽獎券（上限五張），然後有機會得到年度桌遊！（感謝您為群組奉獻）\r\n" + 
                                                               "\r\n" + 
                                                               "5. 請問我要怎麼累積主揪點？\r\n" + 
                                                               "答：請依照格式揪團（群內成員需達50%以上）、且活動完成後，拍照將出席人員tag名字上傳，靜待公關組通知刪文即可～\r\n" + 
                                                               "\r\n" + 
                                                               "6. 想請問「重新認識你」是什麼活動？\r\n" + 
                                                               "答：群組每週會指定群組成員自介，被指定者於週日前完成自介並指定下家（請事先溝通）。不用心急搶先自介唷！\r\n" + 
                                                               "\r\n" + 
                                                               "7. 請問大家過去的自介哪裡找呢？\r\n" + 
                                                               "答：請參考相簿的「重新認識你」，有著活動開始至今的所有自介存檔可參考。\r\n" + 
                                                               "\r\n" + 
                                                               "8. 請問YOYODAY友友爹是什麼？\r\n" + 
                                                               "答：是幹部群每隔週五會輪流開團，群內成員參加需攜帶一名群外友人的桌遊團。\r\n" + 
                                                               "\r\n" + 
                                                               "9. 請問狼窩主題日是什麼？\r\n" + 
                                                               "答：桌遊群每隔兩個月會舉辦的中大型網聚，針對某一主題桌遊進行教學與競賽的聯歡活動。\r\n" + 
                                                               "\r\n" + 
                                                               "10. 我想要跟幹部反應或邀請好友加入？\r\n" + 
                                                               "答：請洽群長Jasper公關小編宣融。");
    }
